...
class SweeperEU:
    ...
    GETDailyCases = "https://corona.lmao.ninja/v2/historical"
    ...
    def get_daily_cases(self):
        ...
        csv_file_path = os.path.join(self.info_dir_path, "eu_daily_cases.csv")
...
class SweeperRO:
    ...
    GETDateLaZI = "https://api1.datelazi.ro/swagger/index.html"
